...
// Custom poster visuals for each role — CSS-based art matching the role's work
const posters = [
  // AI Engineer SUNY — knowledge graph nodes
  ...
  // AI/ML Engineer New Era — bar chart
  ({ className }: { className?: string }) => (
  ...
  // Sr Data Analyst — 3×3 KPI dashboard
  ({ className }: { className?: string }) => (
    <div className={`w-full h-full flex items-center justify-center relative overflow-hidden ${className}`}
        ...
        {experience.map((item, i) => {
          ...
          return (
            <motion.div
              ...
              className="netflix-card group flex flex-col"
            >
              {/* Poster */}
              <div className="relative" style={{ aspectRatio: '16/10', minHeight: 120 }}>
              ...
              <div className="p-5 flex flex-col flex-1">
                <h3 className="font-display font-black text-white text-base leading-tight mb-1 group-hover:text-[#cc2200] transition-colors">
